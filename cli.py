...
if __name__ == '__main__':
	...
	t_parser.add_argument('-sender_ip', type=str, help='The IP address of the sender in the new transaction.', default='127.0.0.1')
	t_parser.add_argument('-sender_port', type=int, help='The port of the sender in the new transaction.')
	t_parser.add_argument('-recip_addr', nargs=1, help='The wallet address of the recipient in the new transaction.')
	...
	b_parser.add_argument('-my_ip', help='The IP address you run your NoobCash service in', default='127.0.0.1')
