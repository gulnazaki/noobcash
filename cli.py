...
if __name__ == '__main__':
	...
	t_parser.add_argument('-sender_addr', nargs=1, help='The IP address of the sender in the new transaction.', default='127.0.0.1')
	...
	t_parser.add_argument('-recip_addr', nargs=1, help='The IP address of the recipient in the new transaction.', default='127.0.0.1')
	t_parser.add_argument('-recip_port', type=int, help='The port of the recipient in the new transaction.')
	t_parser.add_argument('-recip_id', nargs=1, help='The ID of the recipient in the new transaction.')
